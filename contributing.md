...
The code for the project is handled via its [GitHub Repository](https://github.com/justintadlock/avatars-meta-box).  You can open tickets, create patches, and send pull requests there.
